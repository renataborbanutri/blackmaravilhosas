            ...
            <Card className="mb-8 border-2 border-purple-200 shadow-xl">
              <CardContent className="pt-6">
                ...
                >
                  <Button 
                    size="lg" 
                    className="w-full text-lg py-6 bg-green-600 hover:bg-green-700 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                    ...
                    Entrar agora no grupo VIP de WhatsApp
                  </Button>
                </a>
              </CardContent>
            </Card>
